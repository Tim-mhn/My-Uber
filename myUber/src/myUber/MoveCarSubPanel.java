...
public class MoveCarSubPanel extends JPanel implements ActionListener, SubPanels{

	private String output = "";
	private JButton button = new JButton("Move car");
	...
	public void refresh() {
		...
		ArrayList<Car> cars = CarFactory.getInstance().getCars();
		for(Car c : cars) {
	    	((JComboBox) ftf[0]).addItem(c.getID());
	    }
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(button)) {
			...
			String id = (String) ((JComboBox) ftf[0]).getSelectedItem();
			...
			car.setGps(new GPS(longitude, latitude));
			
			output += "Car moved successfully! " + car.toString() + " " + car.getGps();
		}
